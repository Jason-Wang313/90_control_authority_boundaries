...
- [x] Stress tests.
- [x] Negative cases.
- [x] Pairwise terminal gate.
- [x] Paper-specific figures.
- [x] 2026-06-15 source rerun.

## ICLR Main Bar
- [ ] Real-robot validation.
- [ ] High-fidelity simulator benchmark.
- [x] Implemented local closed-loop evidence benchmark.
- [x] Implemented strong local competing baselines.
- [x] Implemented ablations, stress sweep, and negative cases.
- [ ] Implemented learned model checkpoint.
